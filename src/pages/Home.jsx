        ...
        <div style={{ width: "100%", maxWidth: "450px", margin: "0 auto" }}>
          ...
          >
            ...
            <img
              src="/sira_logo.png"
              alt="SIRA"
              style={{ height: "75px", objectFit: "contain", borderRadius: "50%" }}
            />
          </div>
          ...
          <div
            style={{
              marginBottom: "3rem",
              animation:
                "fadeInDown 0.8s cubic-bezier(0.23, 1, 0.32, 1) 0.1s both",
            }}
          >
            <h2
              style={{
          ...
          <form
            ...
            style={{
              animation:
                "fadeInUp 0.8s cubic-bezier(0.23, 1, 0.32, 1) 0.2s both",
            }}
          >
            ...
            <button
              ...
              style={{
                ...
                padding: "1.2rem",
                background:
                  "linear-gradient(135deg, var(--accent-color) 0%, #00225e 100%)",
                color: "white",
                border: "none",
                borderRadius: "18px",
                fontWeight: "600",
              ...
              onMouseEnter={(e) => {
                if (!loading) {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 15px 35px rgba(0, 71, 186, 0.35)";
                }
              }}
              onMouseLeave={(e) => {
                if (!loading) {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 10px 25px rgba(0, 71, 186, 0.25)";
                }
              }}
            >
              {loading ? (
